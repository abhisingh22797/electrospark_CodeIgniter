...
class User extends BaseController
{
    ...
    {
        $this->global['pageTitle'] = 'Electrospark| Admin Dashboard';

        $data['ct_request'] = $this->user_model->count_contact();
    ...
    function userListing()
    {
        if ($this->isAdmin() == TRUE) {
            ...
            $this->global['pageTitle'] = 'FooDcHeM: User Listing';
    ...
    function addNew()
    {
        if ($this->isAdmin() == TRUE) {
            ...
            $this->global['pageTitle'] = 'FooDcHeM: Add New User';
    ...
    function editOld($userId = NULL)
    {
        if ($this->isAdmin() == TRUE || $userId == 1) {
            ...
            $this->global['pageTitle'] = 'Electrospark : Edit User';
    ...
    {
        $this->global['pageTitle'] = 'Electrospark : 404 - Page Not Found';
    ...
    function loginHistoy($userId = NULL)
    {
        if ($this->isAdmin() == TRUE) {
            ...
            $returns = $this->paginationCompress("admin/login-history/" . $userId . "/", $count, 10, 3);

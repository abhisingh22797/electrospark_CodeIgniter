...
class Service extends BaseController
{
    ...
    function serviceListing()
    {
        ...
        {        
            ...
            $this->global['pageTitle'] = 'Electrospark : service Listing';
    ...
    function addNew()
    {
        ...
        {   $data['scat'] = $this->service_model->getServiceCat();
            $this->global['pageTitle'] = 'Electrospark : Add New Service';
    ...
    function editOld($sId = NULL)
    {
            ...
            $this->global['pageTitle'] = 'FooDcHeM : Edit Service';
    ...
    {
        $this->global['pageTitle'] = 'FooDcHeM  : 404 - Page Not Found';
